...
pub const W_CROSS_DOC: &str = "W-CROSS-DOC";
...
pub const E_CROSS_MISSING: &str = "E-CROSS-MISSING";
pub const E_CROSS_SLUG: &str = "E-CROSS-SLUG";
pub const E_CYCLE_CROSS: &str = "E-CYCLE-CROSS";
